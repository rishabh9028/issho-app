                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 py-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <div className="flex-1 w-full order-2 lg:order-1">
                        <div className="relative aspect-square max-w-[500px] mx-auto">
                            <div className="absolute inset-0 bg-[#2F2BFF]/10 rounded-[60px] transform rotate-6"></div>
                            <img 
                            ...
                            <div className="absolute -bottom-10 -left-10 bg-white p-6 rounded-3xl shadow-xl z-20 hidden md:block border border-slate-100">
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="h-12 w-12 rounded-full bg-blue-100 flex items-center justify-center text-[#2F2BFF]">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="h-2 w-2 rounded-full bg-brand-gradient animate-pulse"></span>
                    ...
                    <div className="flex-1 space-y-10 order-1 lg:order-2 text-center lg:text-left">
                        <div className="space-y-4">
                            <span className="inline-block px-4 py-1.5 bg-[#2F2BFF]/10 text-[#2F2BFF] text-xs font-black uppercase tracking-widest rounded-full">
                                Start your journey
                            </span>
                            <h1 className="text-5xl md:text-6xl font-black text-slate-900 leading-tight tracking-tight">
                                Find the perfect space to <span className="text-[#2F2BFF]">create.</span>
                            </h1>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="flex items-start gap-4 p-4 rounded-2xl bg-white border border-slate-100 shadow-sm text-left">
                                <span className="material-symbols-outlined text-[#2F2BFF] bg-[#2F2BFF]/5 p-2 rounded-lg">search</span>
                                <div>
                            ...
                            <div className="flex items-start gap-4 p-4 rounded-2xl bg-white border border-slate-100 shadow-sm text-left">
                                <span className="material-symbols-outlined text-[#2F2BFF] bg-[#2F2BFF]/5 p-2 rounded-lg">favorite</span>
                                <div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                            <Link
                                href="/auth/signup"
                                className="w-full sm:w-auto px-10 py-5 bg-brand-gradient text-white rounded-3xl font-black text-lg transition-all shadow-2xl shadow-blue-500/20 active:scale-[0.98] hover:brightness-110 flex items-center justify-center gap-3"
                            >
                                Join the Community
                            </Link>
                            <Link 
