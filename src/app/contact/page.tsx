export default function ContactPage() {
    return (
        <div className="bg-[#F8FAFF] min-h-screen py-16 px-6 md:px-10">
            <div className="max-w-[1200px] mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        ...
                        {[
                            {
                                ...
                                icon: (
                                    <svg className="w-6 h-6 text-[#2F2BFF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div key={item.title} className="bg-white rounded-xl border border-slate-100 shadow-sm p-6 flex items-start gap-4">
                                <div className="w-12 h-12 rounded-xl bg-[#2F2BFF]/10 flex items-center justify-center flex-shrink-0">
                                    {item.icon}
                                </div>
                                <div>
                    ...
                    {/* Form */}
                    <div className="bg-white rounded-xl shadow-xl border border-[#2F2BFF]/5 p-8">
                        <form className="space-y-4">
                            <div>
                                <label className="block text-sm font-bold mb-2 text-slate-700">Full Name</label>
                                <div className="flex items-center gap-3 px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus-within:border-[#2F2BFF] transition-colors">
                            ...
                            <div>
                                ...
                                <textarea
                                    rows={5}
                                    className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:border-[#2F2BFF] outline-none text-slate-900 placeholder:text-slate-400 text-sm font-medium resize-none transition-colors"
                                    placeholder="How can we help?"
                                />
                            </div>
                            <button
                                type="button"
                                className="w-full h-12 bg-brand-gradient hover:bg-[#1614cc] text-white font-bold rounded-xl transition-all shadow-lg shadow-[#2F2BFF]/20 active:scale-[0.98]"
                            >
                                Send Message
                            </button>
                        </form>
